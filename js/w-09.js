...
array_4_descriptions = document.querySelectorAll(".description");
...
setTimeout(() => {
    array_5_descriptions = document.querySelectorAll(".description");
...
task_7_button.addEventListener("click", () => {
    ...
    description.remove();
    array_7_description = document.querySelectorAll(".description");
